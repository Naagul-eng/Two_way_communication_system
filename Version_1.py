...
class Version_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.cma_alg = cma_alg = digital.adaptive_algorithm_cma( qpsk, .01, 4).base()
        ...
        self.epy_block_3 = epy_block_3.blk(num_dummy_bytes=1500)
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.cons(pmt.PMT_NIL, pmt.init_u8vector(len(b"Hello Node B"), list(b"Hello Node B"))), 1000)
        ...
        self.msg_connect((self.digital_crc_check_0_0, 'ok'), (self.blocks_message_debug_3, 'print_pdu'))
        self.msg_connect((self.digital_crc_check_0_0, 'ok'), (self.epy_block_2, 'in'))
        ...
        self.msg_connect((self.epy_block_1, 'out'), (self.digital_crc_append_0, 'in'))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.channels_channel_model_0_1, 0))
        ...
        self.connect((self.channels_channel_model_0_1, 0), (self.analog_agc_xx_0, 0))
        self.connect((self.channels_channel_model_0_1, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.channels_channel_model_0_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.channels_channel_model_0_1, 0), (self.qtgui_time_sink_x_0, 0))
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_2, 0), (self.blocks_throttle2_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(2.5e9, self.samp_rate)
