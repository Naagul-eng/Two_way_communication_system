...
FRAME_PACING_MS = 250    # Pacing to prevent /tmp write collisions
...
class TransceiverApp(QMainWindow):
    ...
    def initUI(self):
        ...
        # Intercept anchor clicks to open externally via OS
    ...
    def handle_link_click(self, url):
        """Forces local file links to open in default OS viewers instead of inside terminal."""
